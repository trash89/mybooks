...
CREATE or replace view v_books_comments as select v_books.id,v_books.created_at,v_books.name,v_books.langue,v_books.author_id,v_books."firstName",v_books."lastName",v_books.coll_id,v_books.coll_name,comments.comment,comments.id as comment_id from v_books full outer join comments on v_books.id=comments.book_id ;
